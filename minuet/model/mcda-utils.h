...
// PROMETHEE
double preferenceFunction(double diff, double p = 0.1); // teste com 0.3 aqui
vector<vector<double>> calculatePreferenceMatrix(const vector<vector<double>>& evaluationMatrix, const vector<double>& weights, double preferenceThreshold = 0.1); // teste com 0.3 aqui
