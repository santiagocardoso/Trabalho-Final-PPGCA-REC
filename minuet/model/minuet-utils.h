...
public:
	...
	*/
    ...
    // TCC1
	static constexpr double_t FLOOR_SIZE_X = 5708.96; //      Define floor size in X axis
	static constexpr double_t FLOOR_SIZE_Y = 8640.74; //      Define floor size in Y axis
	static constexpr double_t FLOOR_SIZE_X_MIN = 3220.49;     //      Define floor size minimal in X axis (min-X)
	static constexpr double_t FLOOR_SIZE_Y_MIN = 7396.17;     //      Define floor size minimal in Y axis (min-Y)
	static constexpr uint32_t TOTAL_NODES = 599; // Total nodes in scenario
	static constexpr uint64_t TOTAL_TIME_SIMULATION = 600; //87903.0;	// Total steptime simulation
	static constexpr double_t START_TIME_APP = 0.00;	// Start time of the application
	static constexpr double_t FINAL_TIME_APP = 600.0;	// Final time of the application

	/* Teste
	static constexpr double_t FLOOR_SIZE_X = 8000.00; //      Define floor size in X axis
	static constexpr double_t FLOOR_SIZE_Y = 8000.00; //      Define floor size in Y axis
	static constexpr double_t FLOOR_SIZE_X_MIN = 5000.00;     //      Define floor size minimal in X axis (min-X)
	static constexpr double_t FLOOR_SIZE_Y_MIN = 5000.00;     //      Define floor size minimal in Y axis (min-Y)
	static constexpr uint32_t TOTAL_NODES = 3; // Total nodes in scenario
	static constexpr uint64_t TOTAL_TIME_SIMULATION = 100; //87903.0;	// Total steptime simulation
	static constexpr double_t START_TIME_APP = 0.00;	// Start time of the application
	static constexpr double_t FINAL_TIME_APP = 100.0;	// Final time of the application
	*/
	...
	enum CLUSTERING_ALGORITHM {dca, msdc, pctt, social, rtt};	// Clustering Algorithms Types
	static const CLUSTERING_ALGORITHM SELECTED_CLUSTERING_ALGORITHM = rtt;
